...
Comps, precedents, LBO → branded pitch deck, end to end. Same source as the [`pitch-agent`](../../agents/pitch-agent) Cowork plugin — this directory is the Managed Agent cookbook for `POST /v1/agents`.
