...
Parses onboarding docs, runs the rules engine, screens sanctions/PEP, flags gaps. Same source as the [`kyc-screener`](../../agents/kyc-screener) Cowork plugin — this directory is the Managed Agent cookbook for `POST /v1/agents`.
