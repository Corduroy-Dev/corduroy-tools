...
Briefing pack before every client meeting. Same source as the [`meeting-prep-agent`](../../agents/meeting-prep-agent) Cowork plugin — this directory is the Managed Agent cookbook for `POST /v1/agents`.
