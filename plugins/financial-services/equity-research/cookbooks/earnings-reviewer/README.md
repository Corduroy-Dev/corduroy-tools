...
Earnings call + filings → model update → note draft. Same source as the [`earnings-reviewer`](../../agents/earnings-reviewer) Cowork plugin — this directory is the Managed Agent cookbook for `POST /v1/agents`.
