...
Audits pre-generated LP statements before distribution. Same source as the [`statement-auditor`](../../agents/statement-auditor) Cowork plugin — this directory is the Managed Agent cookbook for `POST /v1/agents`.
