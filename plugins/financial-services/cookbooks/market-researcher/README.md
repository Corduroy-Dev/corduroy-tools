...
Sector or theme → industry overview → competitive landscape → peer comps → ideas shortlist → research note. Same source as the [`market-researcher`](../../agents/market-researcher) Cowork plugin — this directory is the Managed Agent cookbook for `POST /v1/agents`.
