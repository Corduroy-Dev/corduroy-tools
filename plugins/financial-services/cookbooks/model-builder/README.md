...
DCF, LBO, 3-statement, comps — built as a file artifact. Same source as the [`model-builder`](../../agents/model-builder) Cowork plugin — this directory is the Managed Agent cookbook for `POST /v1/agents`.
