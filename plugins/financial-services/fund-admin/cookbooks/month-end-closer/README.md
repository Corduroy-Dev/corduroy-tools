...
Accruals, roll-forwards, variance commentary. Same source as the [`month-end-closer`](../../agents/month-end-closer) Cowork plugin — this directory is the Managed Agent cookbook for `POST /v1/agents`.
